...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Edit Data Siswa</h1>
          <p>Halaman untuk edit data siswa</p>
        </div>
          ...
          <div class="col-md-6">
            <div class="tile">
              ...
              <div class="tile-body">
                ...
                $query_edit = mysqli_query($conn, "SELECT * FROM t_siswa WHERE id_siswa='$edit'");
                ...
                <form action="update_siswa.php" method="POST">
                  <div class="form-group">
                    <input class="form-control" type="hidden" name="idSiswa" value="<?php echo $result['id_siswa']; ?>">
                  </div>

                  <div class="form-group">
                    <label class="control-label">Nama Siswa</label>
                    <input class="form-control" type="text" name="namaSiswa" placeholder="Ketikan Nama Lengkap Anda" value="<?php echo $result['nama_siswa']; ?>">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Alamat</label>
                    <textarea class="form-control" rows="4" name="alamat" placeholder="Ketikan Alamat Anda" value="<?php echo $result['alamat']; ?>"></textarea>
                  </div>
                  <div class="form-group">
                    <label class="control-label">Pekerjaan</label>
                    <input class="form-control" type="text" name="pekerjaan" placeholder="Ketikan Pekerjaan Anda" value="<?php echo $result['pekerjaan']; ?>">
                  </div>
