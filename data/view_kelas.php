...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> View Data Kelas</h1>
          <p>Table untuk menampilkan jumlah data Kelas</p>
        </div>
        ...
        <div class="col-lg-7">
          <p class="bs-component">
            <button class="btn btn-primary" type="button">
              <a href="proses/add_kelas.php" style="color: white;"> Tambah Data Kelas</a>
            </button>
          </p>
        </div>
      </div>
            ...
            <div class="table-responsive">
              <table class="table">
                <thead>
                  ...
                  <!--[AWAL] SQL VIEW-->
                  <?php
                    $sql_view = mysqli_query($conn, 'SELECT * FROM t_kelas');
                    ...
                    <tr>
                      ...
                      <td>
                          <button class="btn btn-success" type="button">
                            <a href='proses/edit_kelas.php?edit=<?php echo $result[0];?>' style="color: white;">Edit</a>
                          </button>
                          <button class="btn btn-danger" type="button">
                            <a href='proses/delete_kelas.php?delete=<?php echo $result[0];?>' style="color: white;">Delete</a>
                          </button>
                      </td>
                    </tr>
                  </tbody>
