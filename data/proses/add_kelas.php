...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Tambah Data Kelas</h1>
          <p>Halaman untuk menambahkan jumlah data Kelas</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="add_kelas.php">Tambah Data Kelas</a></li>
        </ul>
      </div>
      <div class="row">
          <div class="col-md-6">
            <div class="tile">
              ...
              <div class="tile-body">
                ...
                <!--[AWAL] CREATE KELAS-->
                <?php
                  //variable $tahun di konversi ke INT
                  //variable $tahun nilainya akan ditambah 1, contoh: 2020+1=2021.
                  $tahun = (int) date('Y');
                  $th_depan = $tahun+1;
                ?>
                ...
                <form action="create_kelas.php" method="POST">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="namaKelas" placeholder="Ketikan Nama Kelas Anda">
                  </div>
                  <div class="form-group">
                    <label class="control-label">Tahun Ajar</label>
                    <input class="form-control" type="text" name="thAjar" value="<?php echo date('Y').'/'.$th_depan; ?>">
                  </div>
