      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Data Nilai</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <!--Nilai Siswa-->
            <li><a class="treeview-item" href="nilai_siswa.php"><i class="icon fa fa-circle-o"></i> Nilai Siswa</a></li>
          </ul>
        </li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          ...
          <p>Table untuk menampilkan jumlah data nilai siswa</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="../index.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item">Data Nilai</li>
          <li class="breadcrumb-item active"><a href="view_nilai.php">View Nilai Siswa</a></li>
              ...
              <table class="table">
                <thead>
                  ...
                  <?php
                    ...
                    $no = 1;
                    while ($result = mysqli_fetch_assoc($sql_view)){
                  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-primary" type="button">
                          <a href="proses/add_nilai.php?id_siswa=<?php echo $result['id_siswa'];?>" style="color: white;"> Input Nilai</a>
                        </button>
                      </td>
                    </tr>
                  </tbody>
