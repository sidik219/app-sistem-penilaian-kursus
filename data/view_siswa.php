...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> View Data Siswa</h1>
          <p>Table untuk menampilkan jumlah data Siswa</p>
        </div>
        ...
        <div class="col-lg-7">
          <p class="bs-component">
            <button class="btn btn-primary" type="button">
              <a href="proses/add_siswa.php" style="color: white;"> Tambah Data Siswa</a>
            </button>
            <button class="btn btn-primary" type="button">
              <a href="cetak_data/cetak_siswa.php" style="color: white;"> Cetak Data Siswa</a>
            </button>
          </p>
        </div>
      </div>
                    ...
                    <tr>
                      ...
                      <td>
                          <button class="btn btn-success" type="button">
                            <a href='proses/edit_siswa.php?edit=<?php echo $result[0];?>' style="color: white;">Edit</a>
                          </button>
                          <button class="btn btn-danger" type="button">
                            <a href='proses/delete_siswa.php?delete=<?php echo $result[0];?>' style="color: white;">Delete</a>
                          </button>
                      </td>
                    </tr>
                  </tbody>
